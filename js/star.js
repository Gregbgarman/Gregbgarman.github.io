...
cannot be used at the JavaScript level. So, to access objects of these data types at the Java level, unique string keys that correspond to each object
...
document.getElementById("printStarImage").addEventListener("click", printImage)
...
document.getElementById("changeBTName").addEventListener("click", changePrinterBTName)
...
function getReceipt2Data(){     //adding printer commands used for generating sample receipt2
    ...
    EloStarPrinterManager.beginDocument(emulation)        //always begin new receipt creation with beginDocument
    EloStarPrinterManager.appendCodepage("CP998")
    EloStarPrinterManager.appendInternational("USA")
    EloStarPrinterManager.appendAlignment("Center")
    EloStarPrinterManager.appendLineFeed(1)
...
function initEmulationTable(){
  EmulationTable = {
    ...
    //TSP100IV
    "TSP143IV (STR-001)":"StarPRNT",
    "Star TSP143IV-UE":"StarPRNT"
  }    
}
